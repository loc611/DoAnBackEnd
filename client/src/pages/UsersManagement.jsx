...
const UsersManagement = () => {
    ...
    const handleResetPassword = async (user) => {
        ...
        if (formValues) {
            try {
                await api.patch(`/users/${user._id}/reset-password`, { password: formValues });
                        ...
                        <table className="w-full text-left text-sm text-gray-600">
                            ...
                            <tbody>
                                {filteredUsers.length === 0 ? (
                                    ...
                                    <tr key={u._id} className="hover:bg-blue-50/50 transition-colors border-b border-gray-50 last:border-0">
