...
const ClassFormModal = ({ isOpen, onClose, classData, onSuccess }) => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            if (classData) {
                await api.put(`/classes/${classData._id}`, payload);
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div className="md:col-span-2">
                            ...
                            <select {...register('homeroomTeacher')} className="w-full px-4 py-2 rounded-lg border border-gray-200 outline-none">
                                ...
                                {teachers.map(t => (
                                    <option key={t._id} value={t._id}>{t.fullName} ({t.teacherCode})</option>
                                ))}
                            </select>
                        </div>
                        <div className="md:col-span-2">
                        ...
                        <table className="w-full text-left text-sm text-gray-600">
                            ...
                            <tbody>
                                {filteredClasses.length === 0 ? (
                                    ...
                                    <tr key={c._id} className="hover:bg-blue-50/50 transition-colors border-b border-gray-50 last:border-0">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex justify-end space-x-1">
                                                <button onClick={() => navigate(`/classes/${c._id}`)} className="p-2 text-emerald-600 hover:bg-emerald-100 rounded-lg transition-colors" title="Xem chi tiết & DSSH">
                                                    <Eye size={18} />
                                                </button>
